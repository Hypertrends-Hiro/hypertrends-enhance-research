...
| GET | `/api/v1/telemetry/catalog` | Catálogo stub de eventos permitidos |
...
Ver `README.md` — sección Postgres + scripts `sql/001_catalog_and_config.sql` y `sql/seed/*.sql`.
...
**Aún no implementada.** Se añadirá: API keys, rate limiting, mTLS, WAF, etc.
